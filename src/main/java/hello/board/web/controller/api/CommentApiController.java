...
public class CommentApiController {
    ...
    public SaveResponse addComment(@RequestBody @Valid SaveRequest request, BindingResult br, @Login User user, @PathVariable Long articleId) {
    ...
    public Page<FindResponse> getComments(@Valid @ModelAttribute("pageRequest") CommentPageRequest pageRequest, BindingResult br, @PathVariable Long articleId) {
    ...
    public UpdateResponse updateComment(@RequestBody @Valid UpdateRequest request, BindingResult br, @Login User user, @PathVariable Long articleId, @PathVariable Long commentId) {
